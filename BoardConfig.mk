...
DEVICE_PATH := device/kyocera/KY-41C
...
TARGET_KERNEL_CONFIG := KY-41C_defconfig
TARGET_KERNEL_SOURCE := kernel/kyocera/KY-41C
...
BOARD_AVB_RECOVERY_KEY_PATH := external/avb/test/data/testkey_rsa4096.pem/sys/class/leds/lcd-backlight/brightness
